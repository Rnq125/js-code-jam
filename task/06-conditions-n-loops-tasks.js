...
function doRectanglesOverlap(rect1, rect2) {
  let boolean = !(rect2.left > rect1.width || rect2.width < rect1.left ||
...
function isInsideCircle(circle, point) {
  if ( Math.pow(circle.center.x - point.x, 2) +
       Math.pow(circle.center.y - point.y, 2) < circle.radius * circle.radius ) {
    return true;
  }
  return false;
}
